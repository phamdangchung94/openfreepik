...
/**
 * POST /api/v1/video/kling-3-4k-image
 *
 * Public API for Kling 3 4K image-to-video.
 * Auth: API key via `Authorization: Bearer sk_xxx`.
 *
 * Body:
 *   { "params": { image, prompt?, image_tail?, duration?, cfg_scale?, generate_audio? } }
 *
