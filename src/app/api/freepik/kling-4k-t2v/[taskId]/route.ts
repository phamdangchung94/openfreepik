...
/**
 * GET /api/freepik/kling-4k-t2v/[taskId]
 *
 * Same usage-log lifecycle + R2-mirror behavior as the kling-v3 poll
 * — see that route's header comment for the full contract.
 */
export const maxDuration = 60;

export const GET = createTaskGetHandler(freepik.kling4k.getTaskT2v, {
  rateLimit: { resource: "kling-4k-t2v-poll", limit: 60, windowSeconds: 60 },
