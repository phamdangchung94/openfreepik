...
/**
 * GET /api/freepik/kling-4k-i2v/[taskId]
 *
 * Same usage-log lifecycle + R2-mirror behavior as the kling-v3 poll.
 */
export const maxDuration = 60;

export const GET = createTaskGetHandler(freepik.kling4k.getTaskI2v, {
  rateLimit: { resource: "kling-4k-i2v-poll", limit: 60, windowSeconds: 60 },
